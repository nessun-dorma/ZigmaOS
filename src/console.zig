...
var row: usize = 0;
var column: usize = 0;
var color: u8 = vgaEntryColor(ConsoleColors.LightGray, ConsoleColors.Black);
var buffer = @intToPtr([*]volatile u16, 0xB8000); // 0xB8000 : Address of Color Text Mode. Used to write to Console ( Text Mode )
